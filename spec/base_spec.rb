  ...
  describe 'UUIDParameter validations' do
    ...
    describe 'translations' do
      ...
      it 'speaks English' do
        I18n.locale = :en
        expect(I18n.t('activemodel.errors.messages.invalid_random_uuid')).to eq('must be a random UUID (v4)')
      end
      it 'parle français' do
        I18n.locale = :fr
        expect(I18n.t('activemodel.errors.messages.invalid_random_uuid')).to eq('doit être un UUID aléatoire (v4)')
      end
    end
  end
end
